...
int AbrirMenu(){
    ...
    Texture2D menu = LoadTexture("C:\\raylib\\raylib\\projects\\VSCode\\Assets\\Menu.png");        // Carrega as texturas a partir de imagens da galeria
    Texture2D tutorial = LoadTexture("C:\\raylib\\raylib\\projects\\VSCode\\Assets\\Tutorial.png");
    SetTargetFPS(60);
