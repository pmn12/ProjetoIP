...
//void desenharCristal(Cristal *cristal, Texture2D messi1){
    
   // DrawTexture(messi1, cristal[0].hitbox_cristal.x, cristal[0].hitbox_cristal.y, RED);
   // DrawTexture(messi1, cristal[1].hitbox_cristal.x, cristal[1].hitbox_cristal.y, RED);
